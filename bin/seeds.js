 ...
 */
 ...
 const books = [
     ...
     },
     {
       ...
       description:
         "To Kill a Mockingbird takes place in the fictional town of Maycomb, Alabama, during the Great Depression. The protagonist is Jean Louise  Finch, an intelligent though unconventional girl who ages from six to nine years old during the course of the novel. She is raised with her brother, Jeremy Atticus , by their widowed father, Atticus Finch. He is a prominent lawyer who encourages his children to be empathetic and just. He notably tells them that it is , alluding to the fact that the birds are innocent and harmless.",
       author: "Harper Lee",
       rating: 8
     },
     {
